...
Note: This is a personal portfolio project created for educational purposes. It is not affiliated with or endorsed by IKEA.
...
All images, icons, and fonts referenced by the pages live in /Assets.
...
git clone https://github.com/katlucena/IKEA.git
cd IKEA

You can open auth.html (the beginning of the user journey) or home.html directly in your browser.

For the best experience, serve the project locally:
...
Future Improvements
To revisit this project and rebuild it using React + TypeScript. 

---------------------------------------

Author
Kat Lucena 
A UI/UX design + front-end development portfolio piece.
